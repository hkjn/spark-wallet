...
RUN dpkg --add-architecture i386 \
  ...
  && apt-get update && apt-get install -y --no-install-recommends winehq-stable=4.0~stretch wine-stable=4.0~stretch wine-stable-amd64=4.0~stretch wine-stable-i386=4.0~stretch
